...
render_session_header(1, "Data Prep", "8:50 - 9:10 AM", "20 min", "Database, schema, warehouse, and 10 operational tables loaded from CSV")
...
PROMPT_1_1 = """Create the following Snowflake objects for our Port of Toronto AI workshop:

1. A database called PORT_YTO_AI
2. A schema called PORT_OPS inside that database
3. A warehouse called PORT_YTO_WH (size MEDIUM, auto-suspend after 60 seconds, auto-resume enabled)
...
```sql
CREATE DATABASE PORT_YTO_AI;
CREATE SCHEMA PORT_YTO_AI.PORT_OPS;
CREATE WAREHOUSE PORT_YTO_WH
  WAREHOUSE_SIZE = 'MEDIUM'
  AUTO_SUSPEND = 60
  AUTO_RESUME = TRUE;

USE DATABASE PORT_YTO_AI;
USE SCHEMA PORT_OPS;
USE WAREHOUSE PORT_YTO_WH;
```
...
In PORT_YTO_AI.PORT_OPS, load data from publicly hosted CSV files into tables.

The CSV files are hosted at these URLs:
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/terminals.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/vessels.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/container_manifests.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/cargo_invoices.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/rail_schedules.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/crane_utilization.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/truck_queue_times.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/port_incident_logs.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/marine_safety_reports.csv
- https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/cbsa_inspection_reports.csv
...
```sql
CREATE OR REPLACE STAGE csv_stage URL = 'https://github.com/sfc-gh-obenning/coco-hol-toronto/raw/refs/heads/main/workshop_guide/static/';
...
|-------|------|-------------|
| TERMINALS | 5 | Toronto port terminals |
| VESSELS | 20 | Ships servicing the Great Lakes |
...
PROMPT_1_3 = """Run a query in PORT_YTO_AI.PORT_OPS that shows every table name and its row count, ordered by row count descending. Format it nicely."""
...
FROM PORT_YTO_AI.INFORMATION_SCHEMA.TABLES
...
render_what_you_built([
    "PORT_YTO_AI database and PORT_OPS schema",
    "PORT_YTO_WH warehouse (Medium, auto-suspend 60s)",
